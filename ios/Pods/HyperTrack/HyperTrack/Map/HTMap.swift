...
@objc public final class HTMap: NSObject {
    ...
    public var isAddressViewShown: Bool = true {
        didSet {
            guard view != nil && view.destinationView != nil else { return }
            view.destinationView.isHidden = !isAddressViewShown
        }
    }
    var isInfoViewShown: Bool = true
    public var isRefocusButtonShown: Bool = true {
        didSet {
            guard view != nil && view.reFocusButton != nil else { return }
            view.reFocusButton.isHidden = !isRefocusButtonShown
        }
    }
    public var isBackButtonShown: Bool = true {
        didSet {
            guard view != nil && view.backButton != nil else { return }
            view.backButton.isHidden = !isBackButtonShown
        }
    }
